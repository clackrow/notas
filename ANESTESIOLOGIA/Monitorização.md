...
- Teste do sistema:
    ...
    - Teste da curva quadrada:
        ...
        ![image.png](ANESTESIOLOGIA/imgs/Monitorização/image.png)
        
    - Amortecimento do sistema:
        - Overdamping:
            - Muito amortecido;
                
                ![image.png](ANESTESIOLOGIA/imgs/Monitorização/image%201.png)
        ...
        - Underdamping:
            - Pouco amortecido;
                ...
                ![image.png](ANESTESIOLOGIA/imgs/Monitorização/image%202.png)
...
- Traçados de PAI:
    ...
    - Complacência:
        ...
        ![image.png](ANESTESIOLOGIA/imgs/Monitorização/image%203.png)
        
    - Pontos da curva:
        
        ![image.png](ANESTESIOLOGIA/imgs/Monitorização/image%204.png)
    ...
    - Curva muda com idade:
        ...
        - Idoso faz curva semelhante a underdamping:
            ...
            ![image.png](ANESTESIOLOGIA/imgs/Monitorização/image%205.png)
...
- Ondas patológicas:
    - **Estenose aórtica:**
        ...
        - Pulso parvus (pulso pequeno, de baixa amplutude) e tardus (lento);
            ...
            ![image.png](ANESTESIOLOGIA/imgs/Monitorização/image%206.png)
            
    - **Regurgitação aórtica:**
        - Dois picos sistólicos
            
            ![image.png](ANESTESIOLOGIA/imgs/Monitorização/image%207.png)
    ...
    - **Cardiomiopatia hipertrófica:**
        - Padrão spike and dome;
            ...
            ![image.png](ANESTESIOLOGIA/imgs/Monitorização/image%208.png)
            
        - Deslocamento da valva mitral que interrompe o fluxo sanguíneo no meio da sístole.
    - **Pulsus alternans:**
        - Disfunção sistólica grave de VE;
            
            ![image.png](ANESTESIOLOGIA/imgs/Monitorização/image%209.png)
...
- Curvas de PVC:
    ...
    - Ondas:
        ...
        ![image.png](ANESTESIOLOGIA/imgs/Monitorização/image%2010.png)
        ...
        - Descenso Y:
            ...
            ![image.png](ANESTESIOLOGIA/imgs/Monitorização/image%2011.png)
            
        - Onda H:
            - Platô de pressão que PODE acontecer antes da onda A.
                
                ![image.png](ANESTESIOLOGIA/imgs/Monitorização/image%2012.png)
                
- Ondas patológicas:
    - Fibrilação atrial:
        
        ![image.png](ANESTESIOLOGIA/imgs/Monitorização/image%2013.png)
        
        - Não tem onda A!!! (que seria a curva de contração atrial);
        - Onda C passa a ser a mais proeminente.
    - Dissociação A-V:
        
        ![image.png](ANESTESIOLOGIA/imgs/Monitorização/image%2014.png)
        
        - Onda A em canhão;
        - Contração contra uma tricúspide fechada.
    - Regurgitação tricúspide:
        
        ![image.png](ANESTESIOLOGIA/imgs/Monitorização/image%2015.png)
    ...
    - Estenose tricúspide:
        ...
        ![image.png](ANESTESIOLOGIA/imgs/Monitorização/image%2016.png)
...
- Beer lambert;
    ...
    - Diferencia o tecido pela variabilidade do sinal;
        ...
        ![image.png](ANESTESIOLOGIA/imgs/Monitorização/image%2017.png)
        
        ![image.png](ANESTESIOLOGIA/imgs/Monitorização/image%2018.png)
...
- Equação do gás alveolar:
    ...
    - O2 consumido = PaCO2 / 0.8
        ...
        ![image.png](ANESTESIOLOGIA/imgs/Monitorização/image%2019.png)
...
- Curvas:
    ...
    ![image.png](ANESTESIOLOGIA/imgs/Monitorização/image%2020.png)
    
- Análises de curva;
    
    ![image.png](ANESTESIOLOGIA/imgs/Monitorização/image%2021.png)
    
    ![image.png](ANESTESIOLOGIA/imgs/Monitorização/image%2022.png)
...
- BIS — índice biespectral:
    ...
    - Espectrograma:
        ...
        ![image.png](ANESTESIOLOGIA/imgs/Monitorização/image%2023.png)
        
        ![image.png](ANESTESIOLOGIA/imgs/Monitorização/image%2024.png)
        
        ![image.png](ANESTESIOLOGIA/imgs/Monitorização/image%2025.png)
        
        ![image.png](ANESTESIOLOGIA/imgs/Monitorização/image%2026.png)
        
        ![image.png](ANESTESIOLOGIA/imgs/Monitorização/image%2027.png)
...
- Doppler transcraniano:
    ...
    - Bons sinais:
        ...
        ![image.png](ANESTESIOLOGIA/imgs/Monitorização/image%2028.png)
    ...
    - Paciente muito hipotenso:
        ...
        - Evolui para morte encefálica
            ...
            ![image.png](ANESTESIOLOGIA/imgs/Monitorização/image%2029.png)
