...
- Mudanças hormonais, mecânicas e metabólicas;
- **Adaptações cardiovasculares:**
    - Aumento de volume plasmático em 40 a 50%;
        - Progesterona estimula SRAA.
    - Aumento de DC em resposta:
        - DC = FC * VS;
        - FC aumenta 20%, VS aumenta 25%.
    - Fenômeno compressão aorto-cava:
        - Compressão cava reduz 20% de DC, em resposta há aumento de tônus simpático;
        - Coxim se:
    ...
    - Lembrar:
        - PA = DC * RVS;
        - Se débito aumenta, para manter PA, progesterona reduz RVS.
    - Ecocardiograma da gestante:
        - Desvio de eixo para esquerda;
        - Aumento de câmaras direitas em 20%, esquerdas em 10%;
        - Derrame pericárdico laminar (insignificante);
        - Dilatação de anéis valvares, exceto aortica;
            - Regurgitação pulmonar, mitral e tricúspide são comuns e fisiológicos.
    - PVC NÃO MUDA!
- **Adaptações pulmonares:**
    ...
    - Na gestante:
        - Diminui CPT;
        - Aumenta VC, diminuindo VRE;
            - Consequentemente diminui CRF;
            - Tolera menos apneia.
        - VRI não muda mais que 5%;
        - Aumenta CI;
        - CVF não muda!!
        - Aumenta volume minuto em 50% por aumento de VC!!!
    - Na gasometria:
        - Lava mais CO2, pCO2 = 30;
        - HCO2 = 20;
        - PaO2 normal, por conta do consumo;
        - pH = 7,44.
    - Na espirometria:
        - É NORMAL, sem alterações — pegadinha de prova!
        - Índice de Tiffeneau:
            - VEF1/CVF = normal!!
- **Coagulação:**
    - Aumento de volume plasmático de 40 a 50%, mas com aumento de hemácias de apenas 25%;
    - Hemodiluição fisiológica — anemia dilucional;
    - Aumento de 1 a 1,5 L de volume intravascular;
    - Hipercoagulabilidade fisiológica:
        - Aumento de Fibrinogênio e Fator VII;
        - Aumento de VIII, IX, X, XII;
        - Redução de XI e XIII;
        - Não muda II, V.
        - NADA DA VIA ANTICOAGULANTE MUDA:
